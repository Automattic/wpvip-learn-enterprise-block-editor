...
const ReadingTimePanel = () => {
  ...
  const postContent = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => select(_wordpress_editor__WEBPACK_IMPORTED_MODULE_1__.store).getEditedPostContent(), []);
