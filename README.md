...
[^note]: These playground demos may not work well directly from the link due to [this issue](https://github.com/WordPress/wordpress-playground/issues/2171). If that's the case try copying and pasting the related `blueprint.json` on playground.wordpress.net/builder
